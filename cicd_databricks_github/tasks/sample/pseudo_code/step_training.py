...
class SampleJob(Job):
    ...
    def train(self, **kwargs):
        ...
        fs_table = "feature_store.scaled_features"
        ...
        # Define the centralized MLflow Model Registry
        ...
        with mlflow.start_run() as run:    
            ...
            # Tracking the data version
            fs_table_version = module.get_table_version(spark,fs_table)
            train_dataset_version = module.get_delta_version(spark,cwd+"train_dataset")
            test_dataset_version = module.get_delta_version(spark,cwd+"test_dataset")
            ...
            # Log model in the Feature store
            fs.log_model(
                model,
            ...
            # Register the model to MLflow MR
